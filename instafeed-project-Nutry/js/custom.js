$(document).ready(function() {
    ...
    var userFeed = new Instafeed({
        ...
        accessToken: '6929570380.1677ed0.66ebdac72a284c5190e3115f1d290eb2',
        sortBy: 'most-recent',
        template: '<div class="col-lg-3 instaimg"><a href="{{image}}" title="{{caption}}" target="_blank"><img src="{{image}}" /+alt="{{caption}}" class="img-fluid"/></a></div>',
        //template: '<div class="col-lg-3 instaimg"><a href="{{image}}"target="_blank"><img src="{{image}}" /+ class="img-fluid"/></a></div>',
        });
